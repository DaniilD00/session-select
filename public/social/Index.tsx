        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Button
              ...
              size="lg"
              className="booking-gradient text-white hover:opacity-90 booking-spring text-xl px-12 py-6 h-auto font-semibold"
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="aspect-square booking-card overflow-hidden booking-transition hover:scale-105 hover:shadow-xl"
                >
                  <div className="w-full h-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center">
                    <span className="text-muted-foreground text-sm">Instagram #{i}</span>
                  </div>
                </a>
              ))}
            </div>
